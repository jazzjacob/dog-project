...
public class AssignmentEightPointEight {
	...
	public void removeDog() {
		String name = getFormattedStringFromUser("Enter the name of the dog");
	...
	public void removeOwner() {
		String ownerName = getFormattedStringFromUser("Enter the name of the owner");
		...
		if (owner != null) {
			...
			printError("no such owner");
		}
	}
	
	public void removeDogsFromOwner(Owner owner) {
	...
	public void removeOwnedDog() {
		String dogName = getFormattedStringFromUser("Enter the name of the dog";
	...
	public void listOwners() {
		if (ownerList.size() == 0) {
			...
			for (Owner owner : ownerList) {
				System.out.println(owner.getName()  + " [" + owner.getDogsString() + "]");
			}	
		}
	}
}